...
\begin{center}
    \begin{tabular}{cc}
        \tikz[baseline=(current bounding box.center)] \pic {simpleBeam}; &
        \tikz[baseline=(current bounding box.center)] \pic {nSpanBeam}; \\
        (a) & (b) \\ [.5em]
        \tikz[baseline=(current bounding box.center)] \pic {cantilever}; &
        \tikz[baseline=(current bounding box.center)] \pic {fixedPinnedBeam}; \\
        (c) & (d)
    \end{tabular}
\end{center}
...
\parbox{.25\textwidth}{\tikz \pic {simpleBeam};}
\begin{align*}
...
\parbox{.25\textwidth}{\tikz \pic {cantilever};}
\begin{align*}
