...
Now, the building from example \ref{helicopter_impulse} is exposed to sudden wind gust. In that case, the dynamics of the structure is defined by a \emph{mass spring damper} system under a constant force suddenly applied. The maximum amplitude is governed by the stationary or homogeneous solution to the differential equation
\begin{align*}
m\ddot{u} + c + ku = F_0 \\
