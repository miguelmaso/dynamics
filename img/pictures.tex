...
\pgfdeclareimage[height=1.5cm]{calling}   {shapes/calling}
\pgfdeclareimage[height=1.5cm]{ballet}    {shapes/ballet}
\pgfdeclareimage[height=1.5cm]{dancing}   {shapes/dancing}
\pgfdeclareimage[height=1.5cm]{handwalk}  {shapes/handwalk}
\pgfdeclareimage[height=1.5cm]{happy}     {shapes/happy}
\pgfdeclareimage[height=1.5cm]{helicopter}{shapes/helicopter}
\pgfdeclareimage[height=1.5cm]{hip-hop}   {shapes/hip-hop}
\pgfdeclareimage[height=1.5cm]{hip-hop-2} {shapes/hip-hop-2}
\pgfdeclareimage[height=1.5cm]{jumping}   {shapes/jumping}
\pgfdeclareimage[height=1.5cm]{music-hall}{shapes/music-hall}
\pgfdeclareimage[height=1.5cm]{saxo}      {shapes/saxo}
\pgfdeclareimage[height=1.5cm]{stone}     {shapes/stone}
\pgfdeclareimage[height=1.5cm]{walking}   {shapes/walking}
...
\tikzsetnextfilename{frame3Pinned}
\begin{tikzpicture}
    \pic{frame3Pinned};
\end{tikzpicture}


\tikzsetnextfilename{frameBracing}
\begin{tikzpicture}
    \pic{frame3Pinned};
\end{tikzpicture}


\tikzsetnextfilename{frameSol}
\begin{tikzpicture}
    \pic{frame3Pinned};
\end{tikzpicture}


\tikzsetnextfilename{frame3PinnedSol}
\begin{tikzpicture}
    \pic{frame3Pinned};
\end{tikzpicture}


\tikzsetnextfilename{frameBracingSol}
\begin{tikzpicture}
    \pic{frame3Pinned};
\end{tikzpicture}
