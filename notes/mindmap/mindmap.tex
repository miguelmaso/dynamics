...
\path [concept color=first] node [concept] (a) at (0,0) {SDOF\\$F=0$}
...
;
\path [concept color=second] node [concept] (b) at (10,0){SDOF\\$F=F(t)$}
    child [grow=140] {node [concept] {Dynamic magnification}
...
;
\path [concept color=third] node [concept] (c) at (20,0) {MDOF}
